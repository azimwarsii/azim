        ...
        <div className="top-20 sm:sticky md:top-28 lg:top-32 md:w-1/2">
          <div className="w-full space-y-4 2xl:space-y-10">
            ...
            <p ref={body} className=" translate-y-10 text-body-1 2xl:text-4xl opacity-0">
              I am an independent full-stack developer and creator based in
              Kolkata, India.
              <br></br>
              <br></br>I develop engaging web and mobile applications
              that inspire users, empowering startups and individuals
              to meet industry standards and create lasting digital impacts.
              {/* <br></br>
              <br></br>
