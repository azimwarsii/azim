        ...
        <div className="col-span-2 grid grid-cols-1 gap-x-4 gap-y-8 text-accent-300 sm:grid-cols-2 sm:gap-y-0 md:grid-cols-1">
          <div className="space-y-3 ">
            ...
            <div className="flex flex-col space-y-3 text-body-2 2xl:text-3xl">
              <a
                href="mailto:azimahmed356@gmail.com"
                className="group relative w-fit cursor-pointer"
                target="_blank"
                rel="noreferrer"
              >
                <span>azimahmed356@gmail.com</span>
          ...
          <div className="space-y-3 ">
            ...
            <div className="space-y-3 text-body-2 2xl:text-3xl">
              ...
              <a
                href="https://github.com/azimwarsii"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
              ...
              <a
                href="https://www.linkedin.com/in/azimwarsii/"
              ...
              <a
                href="https://www.youtube.com/@azimwarsii"
                className="group flex items-center space-x-2"
                target="_blank"
                rel="noreferrer"
              >
